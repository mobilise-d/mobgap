...
This script reproduces gait sequence detection validation results on the
free-living TVS dataset while simulating every supported rough lower-back sensor
...
pipelines = {
    ...
    # We don't run the adaptive algorithm here, as it is very slow and not used
    # as any of the default algorithms anyway.
