...
The plots show the per-recording F1 score for each algorithm and orientation.
Each simulated orientation is produced by converting the TVS recording to body
frame and applying the rough mounting rotations used by the reorientation
validation.
