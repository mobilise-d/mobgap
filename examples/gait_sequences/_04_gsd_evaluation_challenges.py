...
aggregated_results = validate_results.filter(like="agg__")
aggregated_results
...
exploded_results = (
    ...
    .rename_axis("fold")
    .set_index(validate_results["data_labels"].explode(), append=True)
)
