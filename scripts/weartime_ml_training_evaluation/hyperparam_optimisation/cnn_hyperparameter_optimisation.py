...
if resume_file.exists():
    ...
    with open(resume_file) as f:
        ...
        if previous_results.get("total_runtime_seconds"):
...
def create_1d_cnn(
    input_shape, num_conv_layers, filters, kernel_size, pool_size, dropout_rate, dense_units, learning_rate
):
...
for key, cv_scores in param_cv_scores.items():
    ...
    if frequency >= 2:
        ...
        param_stats[key] = {"frequency": frequency, "mean_cv": mean_cv, "weighted_score": score}
...
for key in param_cv_scores.keys():
    ...
    print(
        f"  Config (k={params_display['kernel_size']}, d={params_display['dropout_rate']}, "
